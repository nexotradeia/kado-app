...
const MY_CARDS = [
  { id: 'my-boa1', name: 'Bank of America #1', issuer: 'Bank of America', openedDate: '2019-10-28',
    unit: '%', gradient: ['#991b1b', '#f87171'], categories: {}, base: 1, annualFee: 0, credits: [] },
  { id: 'my-csp', name: 'Chase Sapphire Preferred', issuer: 'Chase', openedDate: '2022-05-01',
    unit: 'x', gradient: ['#1e3a8a', '#3b82f6'], categories: { dining: 3, streaming: 3, travel: 2, online: 3 }, base: 1, annualFee: 95, credits: [] },
  { id: 'my-inkunlimited', name: 'Chase Ink Business Unlimited', issuer: 'Chase', openedDate: '2023-02-01', business: true,
    unit: '%', gradient: ['#0f172a', '#334155'], categories: {}, base: 1.5, annualFee: 0, credits: [] },
  { id: 'my-freedom2023', name: 'Chase Freedom (revisar cuál exacta)', issuer: 'Chase', openedDate: '2023-04-01',
    unit: '%', gradient: ['#2563eb', '#60a5fa'], categories: { dining: 3, drugstore: 3 }, base: 1.5, annualFee: 0, credits: [] },
  { id: 'my-amex2020', name: 'Amex (revisar cuál exacta)', issuer: 'American Express', openedDate: '2020-05-21',
    unit: 'x', gradient: ['#b45309', '#fbbf24'], categories: {}, base: 1, annualFee: 0, credits: [] },
  { id: 'my-boa2', name: 'Bank of America #2', issuer: 'Bank of America', openedDate: '2020-05-07',
    unit: '%', gradient: ['#b91c1c', '#ef4444'], categories: {}, base: 1, annualFee: 0, credits: [] },
  { id: 'my-barclay', name: 'Barclay', issuer: 'Barclays', openedDate: '2017-09-14',
    unit: '%', gradient: ['#334155', '#64748b'], categories: {}, base: 1, annualFee: 0, credits: [] },
  { id: 'my-gap', name: 'GAP Visa', issuer: 'GAP / Synchrony', openedDate: '2017-06-11',
    unit: '%', gradient: ['#1f2937', '#4b5563'], categories: {}, base: 1, annualFee: 0, credits: [] },
  { id: 'my-victoria', name: "Victoria's Secret Angel Card", issuer: "Victoria's Secret / Comenity", openedDate: '2017-01-05',
    unit: '%', gradient: ['#831843', '#ec4899'], categories: {}, base: 0, annualFee: 0, credits: [] },
  { id: 'my-chase2014', name: 'Chase (2014)', issuer: 'Chase', openedDate: '2014-06-09',
    unit: 'x', gradient: ['#1e40af', '#60a5fa'], categories: {}, base: 1, annualFee: 0, credits: [] },
  { id: 'my-amexgold', name: 'Amex Gold', issuer: 'American Express', openedDate: '2023-11-06',
    unit: 'x', gradient: ['#b45309', '#fbbf24'], categories: { dining: 4, groceries: 4, travel: 3 }, base: 1, annualFee: 325, credits: [] },
  { id: 'my-venture', name: 'Capital One Venture', issuer: 'Capital One', openedDate: '2024-05-11',
    unit: 'x', gradient: ['#4c1d95', '#a78bfa'], categories: {}, base: 2, annualFee: 95, credits: [] },
  { id: 'my-inkpreferred', name: 'Chase Ink Business Preferred', issuer: 'Chase', openedDate: '2024-07-01', business: true,
    unit: 'x', gradient: ['#0369a1', '#38bdf8'], categories: { travel: 3, online: 3 }, base: 1, annualFee: 95, credits: [] },
  { id: 'my-united', name: 'United MileagePlus Card', issuer: 'Chase', openedDate: '2025-01-01',
    unit: 'x', gradient: ['#1e3a8a', '#93c5fd'], categories: { travel: 2, dining: 2 }, base: 1, annualFee: 0, credits: [] },
  { id: 'my-applecard', name: 'Apple Card', issuer: 'Goldman Sachs', openedDate: '2025-01-01',
    unit: '%', gradient: ['#374151', '#9ca3af'], categories: { tech: 3, transit: 2 }, base: 1, annualFee: 0, credits: [] },
  { id: 'my-mastercard', name: 'Mastercard (revisar banco exacto)', issuer: '', openedDate: '2022-07-01',
    unit: '%', gradient: ['#78350f', '#f59e0b'], categories: {}, base: 1, annualFee: 0, credits: [] },
  { id: 'my-marriott', name: 'Marriott Bonvoy', issuer: 'Chase', openedDate: '2025-11-01',
    unit: 'x', gradient: ['#78350f', '#d97706'], categories: { dining: 2, groceries: 2, gas: 2, travel: 2 }, base: 1, annualFee: 95, credits: [] },
  { id: 'my-deltagold', name: 'Delta SkyMiles Gold Amex', issuer: 'American Express', openedDate: '2026-02-01',
    unit: 'x', gradient: ['#7f1d1d', '#dc2626'], categories: { dining: 2, groceries: 2, travel: 2 }, base: 1, annualFee: 0, credits: [] }
];
