...
const MY_CARDS = [
  ...
  { id: 'my-freedom2023', name: 'Chase Freedom Unlimited', issuer: 'Chase', openedDate: '2023-04-01',
    unit: '%', gradient: ['#2563eb', '#60a5fa'], categories: { dining: 3, drugstore: 3, travel: 1.5 }, base: 1.5, annualFee: 0, credits: [] },
  { id: 'my-amex2020', name: 'Amex EveryDay', issuer: 'American Express', openedDate: '2020-05-21',
  ...
  { id: 'my-mastercard', name: 'Capital One Mastercard', issuer: 'Capital One', openedDate: '2022-07-01',
